...
const CardProduct: React.FC<CartProductProps> = (props) => {
  ...
  return (
    <Row className="cart-product" data-test={`cart-product-${props.id}`} py-2 mx-1>
      <Col xs={4}>
      ...
      <Col xs={8}>
        <Row>
          ...
          <Col className="cart-product-delete-btn" xs={2}>
            <Trash
              data-test="cart-product-delete-btn"
              size="1em"
        ...
        <Row className="py-2">
          <Col xs={3} className="cart-product-qty" data-test="cart-product-qty">
            Qty.{props.qty}
          </Col>
